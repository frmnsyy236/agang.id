...
import menuRicebowlCheese from '@/assets/chicken tokyo.jpg';
import menuRicebowlOriginal from '@/assets/chicken original.jpg';
import menuRicebowlKatsu from '@/assets/chicken original.jpg';

import menuTaiwanCheese from '@/assets/Taiwan Chesee.jpg';
import menuTaiwanBalado from '@/assets/Taiwan Balado.jpg';
import menuTaiwanBBQ from '@/assets/Taiwan BBQ.jpg';
...
export const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    description: 'Ayam crispy dibalut sambal balado pedas-merah yang menggugah selera.',
    price: 17000,
  ...
  },
  {
    ...
    description: 'Ayam goreng khas Taiwan dengan saus BBQ manis-smokey.',
    price: 17000,
    image: menuTaiwanBBQ,
    category: 'taiwan',
  },
  ...
  //   description: 'Dimsum lembut dengan cita rasa gurih klasik.',
  //   price: 18000,
  ...
  //   description: 'Dimsum lembut dengan saus mentai keju creamy maksimal.',
  //   price: 28000,
  ...
  //   id: 'ds-3',
  //   name: 'Dimsum Mentai',
  //   description: 'Dimsum ayam disiram saus mentai gurih-manis.',
  //   price: 23000,
